...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/api/order/my-order").hasRole("USER").antMatchers("/api/order/all-orders").permitAll().antMatchers("/api/product/add").hasAnyRole("ADMIN","MODERATOR").antMatchers("/api/upload","/api/files","/api/files/**","/api/file/**").permitAll()
